...
import { getTaxFolders } from 'src/redux/slices/tax';
import { useDispatch, useSelector } from 'src/redux/store';
import { RouterLink } from 'src/routes/components';
import { paths } from 'src/routes/paths';
import { ITaxFolder } from 'src/types/tax';
...
export default function TaxReportFolderManagerView() {
...
function applyFilter({
  ...
  if (name) {
    inputData = inputData.filter((folder) => folder.year.indexOf(name.toLowerCase()) !== -1);
  }
